...
public class Alien extends Sprite {
	...
	private SpaceInvaders game;
	 ...
	 //offsetX Offset from the center of the window in the x direction, can be positive or negative
	 //offsetY Offset from the center of the window in the y direction, can be positive or negative
	 //type Determines the type of alien
	 //game The Space Invaders game instance that the aliens are to be added to
	 //pane The pane that is handling the display
	 //type must be between 1 and 3 inclusive
	...
	protected void onCollide(Sprite sprite)
	{
		...
		if(sprite instanceof ShotAlien)
		{
			// Kills this sprite if the shot is moving upwards
			ShotAlien shot = (ShotAlien)sprite;
